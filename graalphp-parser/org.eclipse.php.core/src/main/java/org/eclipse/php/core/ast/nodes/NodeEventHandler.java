...
/**
 * A node event handler is an internal mechanism for receiving notification of
 * changes to nodes in an AST.
 * <p>
 * The default implementation serves as the default event handler that does
 * nothing. Internal subclasses do all the real work.
 * </p>
 * 
...
class NodeEventHandler {
	...
	/**
	 * Reports that the given node has just lose a child. The second half of an
	 * event pair. The default implementation does nothing.
	 * 
	 * @param node
	 *            the node that was modified
	 * @param child
	 *            the child that was removed; note that this node is unparented
	 * @param property
	 *            the child or child list property descriptor
	 ...
	 * @param newChild
	 *            the replacement child; note that this node is unparented
	 * @param property
	 *            the child or child list property descriptor
	 * @see #preReplaceChildEvent(ASTNode, ASTNode, ASTNode,
	 ...
	 *            the node that was modified
	 * @param child
	 *            the node that was replaced; note that this node is unparented
	 * @param newChild
	 *            the replacement child
	 * @param property
	 *            the child or child list property descriptor
	 * @see #postReplaceChildEvent(ASTNode, ASTNode, ASTNode,
	 *      StructuralPropertyDescriptor)
	 * @since 3.0
	 */
