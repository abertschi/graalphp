...
public class SLInteropOperatorTest {
    ...
    @Test
    public void testAdd() {
        final Source src = Source.newBuilder("php", "function testAdd(a,b) {return a + b;} function main() {return testAdd;}", "testAdd.sl").buildLiteral();
    ...
    @Test
    public void testSub() {
        final Source src = Source.newBuilder("php", "function testSub(a,b) {return a - b;} function main() {return testSub;}", "testSub.sl").buildLiteral();
        final Value fnc = context.eval(src);
        final Value res = fnc.execute(1, 2);
        Assert.assertTrue(res.isNumber());
