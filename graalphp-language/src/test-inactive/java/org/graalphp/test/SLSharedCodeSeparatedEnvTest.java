...
public class SLSharedCodeSeparatedEnvTest {
    ...
    public void instrumentsSeeOutputOfBoth() throws Exception {
        ...
        Assert.assertEquals("Output of both contexts and instruments is capturable",
                        "initializingOutputCapture\n" +
                                        "Ahoj1\n" +
                                        "Ahoj2\n" +
                                        "endOfOutputCapture\n",
                        SLJavaInteropTest.toUnixString(outConsumer));

        Assert.assertEquals("Output of instrument goes not to os runtime if specified otherwise",
                        "initializingOutputCapture\n" + "endOfOutputCapture\n",
                        SLJavaInteropTest.toUnixString(osRuntime));
    }
