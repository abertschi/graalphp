...
def binary_trees():
    ...
    ids_php_by_ref = [75, 210]  # php by ref

    ids_php8_by_val = [77, 212]  # php 8 by val
    ids_php8_by_ref = [74, 209]  # php 8 by ref

    ids_hhvm = [76, 211]  # hhvm

    ids_jphp_by_val = [79, 217]  # jphp by val
    ids_jphp_by_ref = [219, 220]  # jphp by ref
    ...
    ids_graalphp_native_by_val = [198, 191, 156, 160, 164]
    ids_graalphp_native_by_ref = [
    ...
    ids = [
        # by val
        ids_php_by_val  # php 7
        , ids_php8_by_val  # php 8
        , ids_jphp_by_val  # jphp
        , ids_hhvm  # hhvm
        , ids_graalphp_native_by_val  # gphp native
        , ids_graalphp_by_val  # gphp
        # by ref
        , ids_php_by_ref
        , ids_php8_by_ref
        , ids_jphp_by_ref
